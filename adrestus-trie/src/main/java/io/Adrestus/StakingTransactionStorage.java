...
public class StakingTransactionStorage implements TransactionStorage {
    ...
    public void deposit(MerklePatriciaTrie<Bytes, PatriciaTreeNode> patriciaTreeImp, String address, double amount)throws CloneNotSupportedException {
        ...
        if (prev.isEmpty()) {
            ...
            double available = prev.get().getAmount() - amount;
            double new_cash = patriciaTreeNode.getStaking_amount() + available;
    ...
    public void withdraw(MerklePatriciaTrie<Bytes, PatriciaTreeNode> patriciaTreeImp, String address, double amount)throws CloneNotSupportedException {
        ...
        if (prev.isEmpty()) {
            ...
            PatriciaTreeNode patriciaTreeNode = (PatriciaTreeNode) prev.get().clone();
            double new_cash = prev.get().getStaking_amount() - amount;
