...
public class BootstrapWithSyncExistedTest {
    ...
    public static void setup() throws Exception {
        ...
        char[] mnemonic8 = "ensure fluid abstract raise duty scare year add danger include smart senior".toCharArray();
        ...
        ECDSASignatureData signatureData8 = ecdsaSign.signSecp256r1Message(HashUtil.sha256(StringUtils.getBytesUtf8(address8)), ecKeyPair8);
        ...
        kad8 = new KademliaData(new SecurityAuditProofs(address8, vk8, ecKeyPair8.getPublicKey(), signatureData8), new NettyConnectionInfo("192.168.1.117", KademliaConfiguration.PORT));
        ...
        committeeBlock.getStructureMap().get(0).put(vk8, "192.168.1.117");
