...
public class KeysTest {
    ...
    public void testCreateSecp256r1KeyPair() throws InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchProviderException {
        ...
        assertEquals("39238291446340184678769765295892952269353051716317326752595290395849166169072", ecKeyPair.getPrivKey().toString());
        assertEquals("13219558520765083084724661669251575557534740818689330502418938789975937142671164642064607206315682893215990855302393233429971338670635453148794084315717402", ecKeyPair.getPubKey().toString());
