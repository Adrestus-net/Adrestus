...
public class LibGMP {
    ...
    } //method to force initialization
    ...
    public static native void __gmpz_gcdext(mpz_t gcd, mpz_t s, mpz_t t, mpz_t a, mpz_t b);

    public static native void __gmpz_fdiv_q(mpz_t q, mpz_t n, mpz_t d);

    public static native void __gmpz_fdiv_q_ui(mpz_t rop, mpz_t op1, NativeLong op2);
