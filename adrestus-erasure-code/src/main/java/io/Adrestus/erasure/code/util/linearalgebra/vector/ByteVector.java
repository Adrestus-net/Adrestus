...
import io.Adrestus.erasure.code.util.linearalgebra.vector.functor.VectorAccumulator;
...
public interface ByteVector extends Iterable<Byte> {
     ...
     *
     * @param multiplier The value to multiply the given vector before it is added to this vector
     * @param vector     the right hand vector for addition
     */
     ...
     *
     * @param ch The channel used to write the serialized form of this vector
