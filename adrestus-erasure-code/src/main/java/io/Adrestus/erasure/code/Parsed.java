 ...
 *
 * @param <V> The type of the parsed value object
 */
public abstract class Parsed<V> {
     ...
     *
     * @param value A valid parsed object
     ...
     * non-existent value.
     *
     * @param failureReason A message detailing the reason for the parsing failure
     ...
     * @throws ParsingFailureException If the parsed value is invalid
     */
