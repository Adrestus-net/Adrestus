...
public final class ByteBuffers {
    ...
    private static BufferType isDirectType(boolean isDirect) {
        ...
        return isDirect ? BufferType.DIRECT : BufferType.ARRAY_BACKED;
    }
     ...
     * @param type     The type of the returned buffer
     ...
     *
     * @param minCapacity The minimum capacity of the cached buffer
     * @param type        The type of the returned buffer
     * @return a cached (per thread) buffer
     * @throws IllegalArgumentException If {@code minCapacity > }{@value #MAX_CACHED_BUFFER_CAPACITY}
     */
     ...
     *
     * @param buf       The source buffer
     * @param sliceSize The size of the slice buffer
     * @return a buffer slice
     * @throws IllegalArgumentException If the size of the slice is negative
     * @throws BufferUnderflowException If the size of the slice exceeds the number of {@linkplain Buffer#remaining() available} bytes in
     *                                  the source buffer
     */
     ...
     *
     * @param buf The source buffer
     * @param op  The operation to apply to the source buffer after being sliced
     * @return a buffer slice
     */
     ...
     *
     * @param buf      The buffer to be copied
     * @param copySize The number of bytes to be copied from the source buffer
     * @return a copy of a buffer
     * @throws IllegalArgumentException If the number of bytes to be copied is negative
     * @throws BufferUnderflowException If the number of bytes to be copied exceeds the number of {@linkplain Buffer#remaining()
     ...
     *
     * @param buf The buffer to be copied
     * @param op  The operation to apply to the source buffer after being copied
     * @return a copy of a buffer
     */
     ...
     *
     * @param array The array to be copied
     * @param off   The starting position of the copy
     ...
     * @throws BufferOverflowException If the number of {@linkplain Buffer#remaining() available} bytes in the source buffer exceeds the
     ...
     *
     * @param src   The source buffer
     * @param srcOp The operation to apply to the source buffer after the copy
     * @param dst   The destination buffer
     * @param dstOp The operation to apply to the destination buffer after the copy
     * @throws BufferOverflowException If the number of {@linkplain Buffer#remaining() available} bytes in the source buffer exceeds the
     *                                 number of available bytes in the destination buffer
     */
     ...
     * @throws IllegalArgumentException If the number of bytes to copy is negative
     * @throws BufferUnderflowException If the number of bytes to copy exceeds the number of {@linkplain Buffer#remaining()
     *                                  available} bytes in the source buffer
     * @throws BufferOverflowException  If the number of bytes to copy exceeds the number of {@linkplain Buffer#remaining()
     ...
     *
     * @param dst The buffer to put zeros into
     */
     ...
     *
     * @param dst      The buffer to put zeros into
     * @param numZeros The number of zeros to put
     * @throws IllegalArgumentException If the number of zeros is negative
     * @throws BufferOverflowException  If the number of zeros exceeds the number of {@linkplain Buffer#remaining() available} bytes in
     *                                  the buffer
     */
     ...
     *
     * @param dst The buffer to put zeros into
     * @param op  The operation to apply to the buffer after the put
     */
