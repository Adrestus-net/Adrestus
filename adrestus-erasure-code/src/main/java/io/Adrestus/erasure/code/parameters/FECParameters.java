...
public final class FECParameters {
     ...
     *
     * @param dataLen  The length of the source data, in number of bytes
     * @param symbSize The size of a symbol, in number of bytes
     * @param numSrcBs The number of source blocks into which the source data is partitioned
     * @return a new {@code FECParameters} instance
     * @throws IllegalArgumentException If the provided FEC parameters are invalid
     */
     ...
     * @param symbSize The size of a symbol, in number of bytes
     * @param numSrcBs The number of source blocks into which the source data is partitioned
     * @param interLen The interleaver length, in number of sub-blocks per source block
     * @return a new {@code FECParameters} instance
     * @throws IllegalArgumentException If the provided FEC parameters are invalid
     */
     ...
     * @throws IllegalArgumentException If the provided deriver parameters are invalid
     */
     ...
     *
     * @param array An array of bytes containing FEC parameters
     ...
     *
     * @param array  An array of bytes containing FEC parameters
     * @param offset The starting index in the array (must be non-negative and less than {@code array.length})
     * @return a container object containing FEC parameters or a parsing failure reason string
     * @throws IndexOutOfBoundsException If the pre-conditions on the array offset do not hold
     * @throws NullPointerException      If the provided array is {@code null}
     */
     ...
     * the parsing failure can be retrieved by calling the method {@link Parsed#failureReason()} </ul>
     *
     * @param buffer A buffer containing FEC parameters
     * @return a container object containing FEC parameters or a parsing failure reason string
     ...
     *
     * @param in A {@code DataInput} object from which FEC parameters are read
     * @return a container object containing FEC parameters or a parsing failure reason string
     ...
     * parsing failure is detected, or an {@code IOException} is throw.
     *
     * @param ch A {@code ReadableByteChannel} object from which FEC parameters are read
     * @return a container object containing FEC parameters or a parsing failure reason string
     ...
     *
     * @param array An array on which the FEC parameters are written
     * @throws IndexOutOfBoundsException If the length of the array is insufficient to hold the FEC parameters
     * @throws NullPointerException      If the provided array is {@code null}
     */
     ...
     *
     * @param array  An array on which the FEC parameters are written
     * @param offset The starting array index at which the FEC parameters are written (must be non-negative)
     ...
     *
     * @param buffer A buffer on which the FEC parameters are written
     * @throws ReadOnlyBufferException If the provided buffer is read-only
     * @throws BufferOverflowException If the provided buffer has less than 12 bytes remaining
     * @throws NullPointerException    If the provided buffer is {@code null}
     */
     ...
     *
     * @param out A {@code DataOutput} object into which the FEC parameters are written
     ...
     * {@code IOException} is throw.
     *
     * @param ch A {@code WritableByteChannel} object into which the FEC parameters are written
     ...
     * @throws ArithmeticException If the cast causes the data length value to overflow
