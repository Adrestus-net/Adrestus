...
public interface ByteMatrix {
     ...
     * @param toRow   The ending row index
     */
     ...
     *
     * @param i          The row index
     * @param fromColumn The first column index (inclusive)
     * @param toColumn   The last column index (exclusive)
     ...
     *
     * @param j       The column index
     * @param fromRow The first row index (inclusive)
     * @param toRow   The last row index (exclusive)
     ...
     *
     * @param i          the row index
     * @param fromColumn the starting column index
     * @param vector     the row represented as vector
     * @param fromIndex  the starting vector index
     ...
     * @param i          the row index
     * @param procedure  the matrix procedure
     * @param fromColumn The starting column (inclusive)
     * @param toColumn   The ending column (exclusive)
     */
     ...
     * @param toRow     The ending row (exclusive)
     */
     ...
     *
     * @param sourceRow The index of the adder row
     * @param destRow   The index of the row being added in place
     */
     ...
     *
     * @param sourceMultiplier The value to multiply the source row before it is added to the destination row
     * @param sourceRow        The index of the adder row
     * @param destRow          The index of the row being added in place
     */
     ...
     *
     * @param ch The channel used to write the serialized form of this matrix
