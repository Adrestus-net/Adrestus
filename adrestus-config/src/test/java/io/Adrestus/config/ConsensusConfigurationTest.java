...
public class ConsensusConfigurationTest {
    ...
    public void test() {
        ...
        assertEquals(17 * 1000, ConsensusConfiguration.CONSENSUS_CONNECTED_RECEIVE_TIMEOUT);
        assertEquals(17 * 1000, ConsensusConfiguration.CONSENSUS_COLLECTED_TIMEOUT);
        assertEquals(17 * 1000, ConsensusConfiguration.CONSENSUS_PUBLISHER_TIMEOUT);
