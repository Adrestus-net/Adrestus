...
public class ConsensusConfigurationTest {
    ...
    public void test() {
        ...
        assertEquals(14 * 1000, ConsensusConfiguration.CONSENSUS_CONNECTED_RECEIVE_TIMEOUT);
        assertEquals(14 * 1000, ConsensusConfiguration.CONSENSUS_COLLECTED_TIMEOUT);
