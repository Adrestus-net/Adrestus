...
public class KademliaConfigurationTest {
    ...
    public void test() {
        ...
        assertEquals("127.0.0.1", KademliaConfiguration.BootstrapNodeIP);
        assertEquals(8080, KademliaConfiguration.BootstrapNodePORT);
        assertEquals(new BigInteger("66346363773430373210313937353263626337313262653530646163623130613265323036646538"), KademliaConfiguration.BootstrapNodeID);
