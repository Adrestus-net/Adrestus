...
public class KafkaMultiNodeFullStartStopTest {
    ...
    private static final int ITERATIONS_MAX = 138;
    ...
    private void StartUp() throws IOException {
        ...
        consensusBroker = new ConsensusBroker(list, list.getFirst(), current_position.getAsInt());
        ...
        try {
            ...
            while (iterations <= ITERATIONS_MAX) {
                ...
                if (leader_position == current_position.getAsInt()) {
                    System.out.println("leader iteration: " + iterations);
...
//                assertEquals(count, consensusBroker.getSequencedMap().get(TopicType.DISPERSE_PHASE2).size());
                    ...
                    System.out.println("Validator iteration: " + iterations);
