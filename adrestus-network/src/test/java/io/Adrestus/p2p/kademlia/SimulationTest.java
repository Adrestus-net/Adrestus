...
public class SimulationTest {
    ...
    public void test() throws ExecutionException, InterruptedException {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            KademliaData kademliaData = new KademliaData(new KademliaData.ValidatorAddressData(addreses.get(i), keypair.get(i).getPublicKey(), signatureData), nettyConnectionInfo);
