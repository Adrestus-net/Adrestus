...
public class NodeUtil {
     ...
     */
    public static <ID extends Number, C extends ConnectionInfo> boolean recentlySeenOrAlive(KademliaNodeAPI<ID, C> kademliaNodeAPI, ExternalNode<ID, C> externalNode, Instant date) {
        if (externalNode.getLastSeen().isAfter(date))
            return true;
