...
public class ExternalNodeSerializer implements JsonSerializer<ExternalNode<Long, NettyConnectionInfo>> {
    @Override
    public JsonElement serialize(ExternalNode<Long, NettyConnectionInfo> src, Type type, JsonSerializationContext context) {
        ...
        jsonNode.add("distance", context.serialize(src.getDistance(), Long.class));
        return jsonNode;
    }
}
