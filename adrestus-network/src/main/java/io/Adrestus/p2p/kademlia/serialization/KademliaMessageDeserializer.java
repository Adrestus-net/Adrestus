...
public class KademliaMessageDeserializer<K extends Serializable, V extends Serializable> implements JsonDeserializer<KademliaMessage<Long, NettyConnectionInfo, Serializable>> {
    ...
    public KademliaMessageDeserializer() {
        this.registerDataType(MessageType.DHT_LOOKUP, new TypeToken<DHTLookupKademliaMessage.DHTLookup<Long, NettyConnectionInfo, K>>() {
        }.getType());
        ...
        this.registerDataType(MessageType.DHT_STORE, new TypeToken<DHTStoreKademliaMessage.DHTData<Long, NettyConnectionInfo, K, V>>() {
        }.getType());
        ...
        this.registerDataType(MessageType.FIND_NODE_REQ, new TypeToken<Long>() {
        }.getType());
        this.registerMessageClass(MessageType.FIND_NODE_REQ, FindNodeRequestMessage.class);
        this.registerDataType(MessageType.FIND_NODE_RES, new TypeToken<FindNodeAnswer<Long, NettyConnectionInfo>>() {
        }.getType());
