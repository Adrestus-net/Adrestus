            ...
            while (VIEW_NUMBER <= ITERATIONS_MAX) {
                ...
                if (position.getAsInt() == 0) {
                    ...
                    if (position.getAsInt() == 1) {
                        ...
                        SerializableErasureObject root = serenc_erasure.decode(finalList.get(System.getProperty("test.arg0") == null ? "192.168.1.106" : System.getProperty("test.arg0")).getFirst());
