...
public class PatriciaNodeStorageTest {
    ...
    public void PublisherTransactionTest() throws InterruptedException {
        ...
        Thread.sleep(500);
        reward.setTimestamp(Instant.now().toString());
        ...
        Thread.sleep(500);
        transaction2.setTimestamp(Instant.now().toString());
        ...
        Thread.sleep(500);
        transaction3.setTimestamp(Instant.now().toString());
        ...
        Thread.sleep(1500);
        transaction3a.setTimestamp(Instant.now().toString());
        ...
        Thread.sleep(500);
        transaction4.setTimestamp(Instant.now().toString());
