...
public class AllTransactionTest {
    ...
    public void staking_test() throws InterruptedException {
        ...
        stakingTransaction.setXAxis(ecKeyPair1.getXpubAxis());
        stakingTransaction.setYAxis(ecKeyPair1.getYpubAxis());
        byte byf[] = serenc.encode(stakingTransaction, 1024);
        stakingTransaction.setHash(HashUtil.sha256_bytetoString(byf));
        ECDSASignatureData signatureData = ecdsaSign.signSecp256r1Message(stakingTransaction.getHash().getBytes(StandardCharsets.UTF_8), ecKeyPair1);
    ...
    public void un_staking_test() throws InterruptedException {
        ...
        unstakingTransaction.setXAxis(ecKeyPair1.getXpubAxis());
        unstakingTransaction.setYAxis(ecKeyPair1.getYpubAxis());
        byte byf[] = serenc.encode(unstakingTransaction, 1024);
        unstakingTransaction.setHash(HashUtil.sha256_bytetoString(byf));
        ECDSASignatureData signatureData = ecdsaSign.signSecp256r1Message(unstakingTransaction.getHash().getBytes(StandardCharsets.UTF_8), ecKeyPair1);
    ...
    public void delegate_test() throws InterruptedException {
        ...
        delegateTransaction.setXAxis(ecKeyPair1.getXpubAxis());
        delegateTransaction.setYAxis(ecKeyPair1.getYpubAxis());
        byte byf[] = serenc.encode(delegateTransaction, 1024);
        delegateTransaction.setHash(HashUtil.sha256_bytetoString(byf));
        ECDSASignatureData signatureData = ecdsaSign.signSecp256r1Message(delegateTransaction.getHash().getBytes(StandardCharsets.UTF_8), ecKeyPair1);
    ...
    public void undelegate_test() throws InterruptedException {
        ...
        unDelegateTransaction.setXAxis(ecKeyPair1.getXpubAxis());
        unDelegateTransaction.setYAxis(ecKeyPair1.getYpubAxis());
        byte byf[] = serenc.encode(unDelegateTransaction, 1024);
        unDelegateTransaction.setHash(HashUtil.sha256_bytetoString(byf));
        ECDSASignatureData signatureData = ecdsaSign.signSecp256r1Message(unDelegateTransaction.getHash().getBytes(StandardCharsets.UTF_8), ecKeyPair1);
    ...
    public void delegate2WithTimestampDelay_test() throws InterruptedException {
        ...
        delegateTransaction2.setXAxis(ecKeyPair1.getXpubAxis());
        delegateTransaction2.setYAxis(ecKeyPair1.getYpubAxis());
